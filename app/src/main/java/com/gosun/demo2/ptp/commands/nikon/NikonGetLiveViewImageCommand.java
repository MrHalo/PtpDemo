 ...
 */
package com.gosun.demo2.ptp.commands.nikon;
...
import com.gosun.demo2.ptp.NikonCamera;
import com.gosun.demo2.ptp.PacketUtil;
...
public class NikonGetLiveViewImageCommand extends NikonCommand {
    ...
    protected void decodeData(ByteBuffer b, int length) {
        ...
        case PtpConstants.Product.NikonD700:
            pictureOffset = 64;
            break;
        case PtpConstants.Product.NikonD7000:
        case PtpConstants.Product.NikonD5100:
            pictureOffset = 384;
            break;
        default:
