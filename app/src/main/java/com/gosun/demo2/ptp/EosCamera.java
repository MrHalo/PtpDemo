...
import com.gosun.demo2.ptp.commands.eos.EosEventCheckCommand;
import com.gosun.demo2.ptp.commands.eos.EosGetLiveViewPictureCommand;
import com.gosun.demo2.ptp.commands.eos.EosOpenSessionAction;
import com.gosun.demo2.ptp.commands.eos.EosSetLiveViewAction;
import com.gosun.demo2.ptp.commands.eos.EosSetPropertyCommand;
import com.gosun.demo2.ptp.commands.eos.EosTakePictureCommand;
...
public class EosCamera extends PtpCamera {
    ...
    protected void onOperationCodesReceived(Set<Integer> operations) {
        ...
        if (operations.contains(PtpConstants.Operation.EosDriveLens)) {
            driveLensSupported = true;
        }
        if (operations.contains(PtpConstants.Operation.EosRemoteReleaseOn) && operations.contains(PtpConstants.Operation.EosRemoteReleaseOff)) {
...
//    @Override
//    protected void queueGetOH() {
//        queue.add(new GetObjectHandlesCommand(this, ))
//    }
    ...
    public void capture() {
        if (isBulbCurrentShutterSpeed()) {
            queue.add(new SimpleCommand(this, cameraIsCapturing ? PtpConstants.Operation.EosBulbEnd : PtpConstants.Operation.EosBulbStart));
        } else {
